...
export class SettingsComponent implements OnInit {
  ...
  settingsForm = this.fb.group({
    ...
    serviceName: [undefined, [Validators.required, Validators.maxLength(50)]],
    departementName: [undefined, [Validators.required, Validators.maxLength(50)]],
    plateauName: [undefined, [Validators.required]],
  ...
  private accountFromForm(): any {
    ...
    return {
      ...
      serviceName: this.settingsForm.get('serviceName').value,
      departementName: this.settingsForm.get('departementName').value,
      plateauName: this.settingsForm.get('plateauName').value,
  ...
  updateForm(account: any): void {
    this.settingsForm.patchValue({
      ...
      departementName: account.departementName,
      plateauName: account.plateauName,
      email: account.email,
